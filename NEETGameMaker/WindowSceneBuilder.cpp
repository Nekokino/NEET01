...
void WindowSceneBuilder::SceneBuild()
{
	...
	Autoptr<NTPieceWindow> ActualWin01 = Window01->AddComponent<NTPieceWindow>(5, 3, 0.45f);
	...
	Autoptr<NTSpRenderer> PlaneAtk01 = Window01->AddComponent<NTSpRenderer>(L"SmallIcon.png", UILayer);
	...
	Autoptr<NTFontRenderer> Atk01 = Window01->AddComponent<NTFontRenderer>(L"±Ã¼­", UILayer);
	...
	Autoptr<NTSpRenderer> PlaneDef01 = Window01->AddComponent<NTSpRenderer>(L"SmallIcon.png", UILayer);
	...
	Autoptr<NTFontRenderer> Def01 = Window01->AddComponent<NTFontRenderer>(L"±Ã¼­", UILayer);
